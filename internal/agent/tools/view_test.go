...
func (m mockFileTracker) LastWriteTime(ctx context.Context, sessionID, path string) time.Time {
	return time.Time{}
}

func (m mockFileTracker) ListWriteFiles(ctx context.Context, sessionID string) ([]string, error) {
	return nil, nil
}
