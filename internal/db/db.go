...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.listSessionWriteFilesStmt, err = db.PrepareContext(ctx, listSessionWriteFiles); err != nil {
		return nil, fmt.Errorf("error preparing query ListSessionWriteFiles: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.listSessionWriteFilesStmt != nil {
		if cerr := q.listSessionWriteFilesStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing listSessionWriteFilesStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	listSessionWriteFilesStmt            *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		listSessionWriteFilesStmt:            q.listSessionWriteFilesStmt,
